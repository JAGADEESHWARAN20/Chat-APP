...
function UnifiedHomeContent({ initialSidebarState = "collapsed", sidebarState }: UnifiedHomeProps) {
  ...
  // Access theme state from store or context for immediate updates
  // const isDarkMode = useUnifiedStore((s) => s.darkMode); // Assuming you have darkMode in store
  // const setDarkMode = useUnifiedStore((s) => s.setDarkMode);
...
<main
  style={mainStyle}
  className="flex-1 flex flex-col min-w-0 relative z-0 transition-all"
>
  {/* TOP HEADER */}
  <header
    className="w-full border-b flex-none sticky top-0 z-20 flex items-center justify-between px-4 backdrop-blur-xl"
    style={{
      ...
      <>
        ...
        <div className="flex items-center gap-1 flex-1 justify-end">
          ...
          <Button
            ...
            style={{
              backgroundColor: manualRightOpen
                ? `${layoutStyles.accentColor} / 0.5`
                : "transparent",
            }}
          >
            <Settings
      ...
      {useUnifiedStore.getState().activeTab === "home" ? (
        ...
        >
          ...
          <div
            ...
            style={{ height: "var(--messages-area-height)" }}
          >
            {/* CHAT HEADER */}
            <div
              className="flex-none px-4 border-b"
              style={{
              ...
              <div className="absolute inset-0 flex flex-col">
                {user && selectedRoomId ? (
                  ...
                  <div
                    ...
                    style={{ padding: `calc(${layoutStyles.spacingUnit} * 2)` }}
                  >
                    <ChatAbout />
                  </div>
                )}
