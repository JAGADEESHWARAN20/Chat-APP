  ...
  return (
    <div className="flex-1 flex flex-col h-[85vh] min-h-0 overflow-hidden">
      <div
        ...
        className="flex-1 overflow-y-scroll h-[80vh] pb-4 overflow-x-hidden px-4 py-2 space-y-4 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent"
        style={{ maxWidth: "100%" }}
      >
