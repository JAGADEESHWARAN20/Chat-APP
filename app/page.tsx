...
export default function Page() {
  ...
  const setRoomUser = useRoomStore((state) => state.setUser); // ✅ Sync to RoomStore

  // ✅ You removed these accidentally — ADD THEM BACK:
  ...
  useEffect(() => {
    // ✅ Sync Zustand user store so notifications & messages work
